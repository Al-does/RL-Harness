...
- 2026-08-02 — Added `devops.git.assert_branch` CLI/helper and agent-skill
  guidance so mutating git commands can fail fast when HEAD drifted. Cursor
  platform behavior is unchanged; separate worktrees per concurrent agent
